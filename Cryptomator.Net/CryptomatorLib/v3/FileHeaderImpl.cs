...
namespace CryptomatorLib.V3
{
    ...
    /// </summary>
    internal sealed class FileHeaderImpl : FileHeader
    {
        ...
        internal const int NONCE_LEN = 12; // 96 bits
        ...
        internal FileHeaderImpl(int seedId, byte[] nonce, DestroyableSecretKey contentKey)
        {
