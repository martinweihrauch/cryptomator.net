...
using CryptomatorLib.V3; // Assuming V3 implementation for now
using CryptomatorLib.VaultHelpers; // Added for VaultKeyHelper

namespace CryptomatorLib
{
    /// <summary>
    /// Represents an unlocked Cryptomator vault and provides high-level access
